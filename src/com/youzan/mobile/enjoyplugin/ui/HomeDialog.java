...
//        }
    ...
    private void insetStringAfterOffset(@NotNull AnActionEvent e, List<ModuleInfo> data) {
        ...
        ApplicationManager.getApplication().invokeLater(new Runnable() {
            ...
            public void run() {
                //构建json，准备保存文件
                String branch = Utils.getCurrentBranch(e, e.getProject().getBasePath());
...
//                for (Map.Entry<String, EnjoyModule> stringEnjoyModuleEntry : FileManager.getInstance(e).loadEnjoyModule().loadEntrySet()) {
//                    modules.add(stringEnjoyModuleEntry.getValue());
//                }
...
//        }
        ...
        try {
            ...
            System.out.println("just look it");
        }
    }
